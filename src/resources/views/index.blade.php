...
<script src="{{asset('vendor/lskstc/definedform/js/jquery-latest.js')}}"></script>
<script src="{{asset('vendor/lskstc/definedform/js/d3.v3.min.js')}}"></script>
<script src="{{asset('vendor/lskstc/definedform/js/dagre-d3.min.js')}}"></script>
<script>
